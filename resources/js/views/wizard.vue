        ...
        <div v-else-if="question.answer_type === QuestionAnswerType.key">
          ...
          <div v-if="question.options?.key === 'team_members'">
            ...
            <div class="action-bt-member">
              <el-button v-if="!wizardState.disable" type="primary" @click="teamMemberAdd">
                {{ $t("wizard.mainContactDetail.titleButtonAddMemeber") }}
              </el-button>
              <el-button v-show="teamMemberData.length > 1 && !wizardState.disable" class="remove-member" @click="teamMemberRemove">
...
const applicantProfileData: Ref<ApplicantProfile> = ref({
  ...
  email: "",
  phone: "",
  current_status: ApplicantCurrentStatus.employed,
});
